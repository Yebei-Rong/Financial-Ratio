...
average_trade_payables  = (530.8+ 370.5)/2
revenue = 14377.9
...
EBIT = 7125.9
interest_payment = 43.3 #last year
...
fixed_charge_coverage = (EBIT+lease_payment)/(interest_payment+lease_payment) 

NI = 5993.3-5*0.16  
gross_profit = revenue-COGS 
opeating_income = 7078.6 
tax_rate = 16.25/100 
average_total_capital = average_total_asset 
...
purchase = 804.2-929.9+COGS
average_trade_payables  = (395.5+ 370.5)/2
revenue = 13452.9
...
tax_rate = 16.25/100 
average_total_capital = average_total_asset # = total asset ;total liability#Short Term Debt + Long Term Debt + Shareholder’s Equity
###profitability ratios
net_profit_margin = NI/revenue
gross_profit_margin = gross_profit/revenue#
operating_profit_margin = opeating_income/revenue#/= EBIT/revenue
